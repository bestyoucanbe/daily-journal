...
const ArrListofJournalEntries = [];

ArrListofJournalEntries.push(objectsJournalEntry[0]);//Pushing each item at a time into the Array!
ArrListofJournalEntries.push(objectsJournalEntry[1]);
ArrListofJournalEntries.push(objectsJournalEntry[2]);

console.log(ArrListofJournalEntries);
//Daily Journal 2 To Here--------------